        ...
        <div className='bg-white p-6 rounded-lg grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div>
            ...
            <ul className='text-gray-700 mb-4 space-y-2'>
              <li>
                <a
                  href='https://github.com/abdellatifennader/next-auth-app'
                  target='_blank'
          ...
          <div className='flex justify-center items-center'>
            <img
              ...
              className='rounded-lg h-96 w-full object-cover grayscale hover:grayscale-0 transition duration-300'
            />
          </div>
        </div>
      </div>
