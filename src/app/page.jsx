  ...
  return (
    <div className='px-4 py-12 max-w-4xl mx-auto'>
      ...
      <div className='bg-white p-6 rounded-lg flex flex-col items-center'>
        <img
          src='https://optimalidm.com/wp-content/uploads/2020/06/Types-of-Authentication-2048x908.jpg'
          alt='Authentication Illustration'
          className='rounded-lg h-96 w-full object-cover mb-6 grayscale hover:grayscale-0 transition duration-300'
        />
        <div>
